...
import { LayoutDashboard, Calendar, BarChart3, User, Settings, Bell, CheckCircle, Clock, PlusCircle, ArrowRight, Download, Phone, X, Menu } from 'lucide-react';
    ...
    const sidebarContent = (
        <>
            <div className="flex items-center justify-between h-20 border-b px-6">
                <h1 className="md:text-2xl text-xl font-bold font-serif text-[#15803D]">PurnAyu</h1>
